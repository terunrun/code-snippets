...
LOCATIONS = [
    "us-east5", "us-central1", "us-west4", "us-west2", "northamerica-northeast1", "us-east4", "us-west1", "us-west3",
    "southamerica-east1", "southamerica-west1", "us-east1", "northamerica-northeast2", "asia-south2", "asia-east2",
    "asia-southeast2", "australia-southeast2", "asia-south1","asia-northeast2", "asia-northeast3", "asia-southeast1",
    "australia-southeast1", "asia-east1", "asia-northeast1", "europe-west1", "europe-north1", "europe-west3", "europe-west2",
...
def main():
    ...
    with open(f'./output_bq_scheduled_query_{target_organization}.csv', 'w') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(["プロジェクト", "スケジュールクエリ名", "ロケーション", "有効/無効", "ステータス", "ユーザー"])
        ...
        for folder in folders:
            ...
            for project in projects:
                ...
                if service.state != service_usage_v1.State.ENABLED:
                    print(f"\t\tBigQuery Data Transfer API is not enabled in Project: {project.project_id}")
                ...
                for location in LOCATIONS:
                    ...
                    transfer_configs = transfer_client.list_transfer_configs(parent=f"projects/{project.project_id}/locations/{location}")
